    ...
    <!-- Background -->
        ...
        <div id="sectionNav"
            ...
            <div class="max-w-7xl mx-auto flex justify-center gap-6 md:gap-10 text-lg md:text-xl py-4">
                ...
                <a href="{{ route('beranda.riwayat') }}" class="hover:text-[#13810A] transition-all duration-200">Riwayat
                    Pesanan</a>
            </div>
        </div>
        ...
        <section id="home" class="flex justify-center items-start mt-[300px] px-6 relative z-10">
            <div
                class="bg-gradient-to-r from-[#7A0010]/90 to-[#B3001B]/90 p-6 rounded-3xl shadow-2xl w-full max-w-[1500px]">
                    ...
                    <div class="flex flex-col gap-4 w-full md:w-[45%]">
                        <div>
                            <label for="category_field_id"
                                class="text-white font-semibold mb-1 block text-lg text-center">Tipe
                                Lapangan</label>
