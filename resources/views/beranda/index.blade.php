    ...
    @section('content')
                    ...
                    <div class="flex flex-col gap-4 w-full md:w-[45%]">
                        <div>
                            <label for="tanggal_main"
                                class="text-white font-semibold mb-1 block text-lg text-center">Tanggal
                                Main</label>
        ...
        <!-- Card Lapangan -->
        @php
            // Jika ini hasil search → tampilkan semua hasil pencarian
            // Jika bukan search dan bukan showAll → batasi 4
            $displayCount = $isSearch || $showAll ? count($fields) : 4;

        @endphp


        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1500px] mx-auto mt-16 w-[97%]">
            @forelse (array_slice($fields, 0, $displayCount) as $field)
                @php
                ...
                <div onclick="window.location='{{ route('beranda.booking.show', $field['id']) }}'"
                    ...
                    <div
                        ...
                        {{-- Tampilkan status jika ini hasil search --}}
                        @if ($isSearch)
            ...
            <section id="kontak" class="py-20 px-6 md:py-12 md:px-12 bg-gray-50 text-center">
                ...
                <div class="bg-white rounded-2xl p-8 mx-auto w-[97%] max-w-[1500px] shadow-xl">
                    ...
                    <div class="flex items-start space-x-4 pb-6 border-b border-gray-200">
                        <div
                            class="bg-[#7A0010] text-white w-12 h-12 flex items-center justify-center rounded-full text-xl">
