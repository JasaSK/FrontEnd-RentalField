...
<body class="text-black relative overflow-x-hidden">
    ...
    <!--footer-->
    <footer
        class="w-screen bg-white py-14 border-t shadow-[0_-4px_10px_rgba(0,0,0,0.1)] relative left-1/2 -translate-x-1/2">
        <div class="max-w-6xl mx-auto px-6 md:px-12">
            <div class="flex justify-center items-center space-x-6 mb-10">
                <a href="https://www.instagram.com/"
                    class="bg-[#13810A] hover:bg-[#0f6508] transition text-black w-12 h-12 rounded-full flex items-center justify-center">
            ...
            <div class="w-full text-left">
                ...
                <p class="text-gray-700 text-sm md:text-base leading-relaxed mb-8">
                    Lapangan Futsal kami menyediakan fasilitas terbaik untuk Anda yang ingin bermain dengan nyaman dan
                    aman.
                ...
                <a href="{{ route('beranda.index') }}"
                    class="home inline-block bg-[#13810A] hover:bg-[#0f6508] transition text-white font-semibold px-6 py-3 rounded-md text-lg">
                    Pesan Sekarang >>
                </a>
            </div>
        </div>
