    ...
    <div class="max-w-[800px] mx-auto bg-white shadow-md rounded-2xl p-8 border border-gray-200">
        ...
        <form action="" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="booking_id" required placeholder="Masukkan Kode Pemesanan"
            ...
            <div>
                ...
                <select name="bank" required class="w-full p-3 border rounded-xl focus:ring-2 focus:ring-red-500">
            ...
            <div>
                ...
                <input type="text" name="no_rekening" required placeholder="Masukkan nomor rekening"
                    class="w-full p-3 border rounded-xl focus:ring-2 focus:ring-red-500">
            </div>
            ...
            <div>
                ...
                <textarea name="alasan" rows="4" required placeholder="Isi alasan pengajuan refund"
