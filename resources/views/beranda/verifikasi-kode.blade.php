        ...
        <div class="w-full border border-gray-300 rounded-md shadow-md bg-white p-6">
            ...
            <div class="flex justify-center gap-3 mb-5">
                <input type="text" maxlength="1"
                    class="w-10 h-10 sm:w-12 sm:h-12 bg-[#13810A9E] text-white border border-[#13810A] rounded-md text-center text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-[#0f6d09]" />
                <input type="text" maxlength="1"
                    class="w-10 h-10 sm:w-12 sm:h-12 bg-[#13810A9E] text-white border border-[#13810A] rounded-md text-center text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-[#0f6d09]" />
                <input type="text" maxlength="1"
                    class="w-10 h-10 sm:w-12 sm:h-12 bg-[#13810A9E] text-white border border-[#13810A] rounded-md text-center text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-[#0f6d09]" />
