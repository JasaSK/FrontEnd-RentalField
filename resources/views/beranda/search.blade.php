...
<section class="mt-10 text-center">
  <h2 class="text-2xl font-bold mb-6 text-green-700">Lapangan Tersedia</h2>

  <!-- Grid Lapangan Tersedia -->
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-6 w-[97%] max-w-[1500px]">
    @php
    $lapanganTersedia = [
...
<section class="mt-16 text-center">
  <h2 class="text-2xl font-bold mb-6 text-red-700">Lapangan Tidak Tersedia</h2>

  <!-- Grid Lapangan Tidak Tersedia -->
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-6 w-[97%] max-w-[1500px]">
    @php
    $lapanganTidakTersedia = [
    ...
    @foreach($lapanganTidakTersedia as $lapangan)
    <div class="relative rounded-2xl overflow-hidden shadow-lg group cursor-pointer hover:shadow-2xl transition">
      <img
        src="{{ asset($lapangan->foto) }}"
        alt="{{ $lapangan->nama }}"
        class="w-full h-56 object-cover opacity-70 group-hover:scale-110 transition duration-500">
