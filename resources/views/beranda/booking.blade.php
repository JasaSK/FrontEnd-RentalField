    ...
    <section class="min-h-screen bg-gradient-to-b from-white to-emerald-50 py-12 md:py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="space-y-6">
                    <div
                        ...
                        @if (!empty($field) && !empty($schedules) && count($schedules) > 0)
                            <div class="p-6 md:p-8">
                                <!-- TITLE -->
                                <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Maintenance</h3>
                                    ...
                                    @foreach ($schedules as $schedule)
                                        <div
                                            ...
                                            <div class="flex-1 text-gray-700">
                                                <div class="font-semibold text-gray-900">{{ $schedule['date'] }}</div>
                                                <div class="text-sm text-gray-600 mt-1">🕒 {{ $schedule['start_time'] }} -
                        ...
                        @else
                            ...
                            <div class="h-80 flex flex-col items-center justify-center p-8 text-center">
                                ...
                                <p class="text-xl font-semibold text-gray-400 mb-2">Tidak ada jadwal maintenance</p>
                                <p class="text-gray-500">Lapangan tersedia tanpa maintenance</p>
                            </div>
                        @endif
                    </div>
                </div>
               ...
               disabled:bg-gradient-to-r disabled:from-gray-500 disabled:via-gray-400 disabled:to-gray-600
               disabled:hover:from-gray-500 disabled:hover:via-gray-400 disabled:hover:to-gray-600
